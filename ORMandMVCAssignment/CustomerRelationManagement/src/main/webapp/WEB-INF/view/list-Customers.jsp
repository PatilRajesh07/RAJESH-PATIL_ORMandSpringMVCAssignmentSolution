...
<body class="bg-light">
	<div
		...
		<div class="container">
			...
			<form action="/CustomerRelationManagement/customers/search"
				class="form-inline">

				<!-- Add a button -->
				<div class="col-sm-5">
					<a href="/CustomerRelationManagement/customers/showFormForAdd"
						class="btn btn-outline-info btn-lg btn-sm mr-2 mb-3 shadow rounded">
						<i class="fa fa-user-plus" aria-hidden="true"></i> Add Customer
					</a> <a href="/CustomerRelationManagement/customers/list"
				...
				<div class="col-sm-7">
					...
					<a href="/CustomerRelationManagement/"
						class="btn btn-outline-info btn-lg btn-sm mr-2 mb-3 shadow rounded">
						...
						<tr>
							...
							<td>
								<div style="text-align: center">
									...
									<a
										href="/CustomerRelationManagement/customers/showFormForUpdate?customerId=${tempCustomer.id}"
										class="btn btn-outline-info btn-lg btn-sm shadow rounded"><i
										class="fas fa-pen"></i> Update </a> |

									<!-- Add "delete" button/link -->
									<a
										href="/CustomerRelationManagement/customers/delete?customerId=${tempCustomer.id}"
